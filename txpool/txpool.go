...
// engine.
//
//go:generate mockgen -destination ./mock_txpool.go -package txpool -source ./txpool.go -typed
...
func NewTxPool[T any, Constraint consensus.TXConstraint[T]](config Config) TxPool[T, Constraint] {
