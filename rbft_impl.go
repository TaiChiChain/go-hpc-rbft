...
func (rbft *rbftImpl[T, Constraint]) postBatches(batches []*txpool.RequestHashBatch) {
...
func (rbft *rbftImpl[T, Constraint]) recvRequestBatch(reqBatch *txpool.RequestHashBatch) error {
