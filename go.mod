...
require (
	...
	github.com/hyperchain/go-hpc-common v0.3.20
	github.com/hyperchain/go-hpc-txpool v1.0.1
...
replace github.com/hyperchain/go-hpc-txpool => git.hyperchain.cn/hyperchain/go-hpc-txpool.git v1.0.1
