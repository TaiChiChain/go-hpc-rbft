...
// engine.
//
//go:generate mockgen -destination mock_mempool.go -package mempool -source ./mempool.go
type MemPool[T any, Constraint consensus.TXConstraint[T]] interface {
	...
	// time by time.
	AddNewRequests(txs [][]byte, isPrimary bool, local, isReplace bool) ([]*RequestHashBatch[T, Constraint], []string)
