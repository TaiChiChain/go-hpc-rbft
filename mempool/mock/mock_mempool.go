...
import (
	...
	mempool "github.com/axiomesh/axiom-bft/mempool"
...
func (m *MockMemPool[T, Constraint]) AddNewRequests(txs [][]byte, isPrimary, local, isReplace bool) ([]*mempool.RequestHashBatch[T, Constraint], []string) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddNewRequests", txs, isPrimary, local, isReplace)
	ret0, _ := ret[0].([]*mempool.RequestHashBatch[T, Constraint])
	ret1, _ := ret[1].([]string)
	return ret0, ret1
}
...
func (m *MockMemPool[T, Constraint]) GenerateRequestBatch() []*mempool.RequestHashBatch[T, Constraint] {
	m.ctrl.T.Helper()
...
func (m *MockMemPool[T, Constraint]) IsConfigBatch(batchHash string) bool {
	m.ctrl.T.Helper()
...
func (mr *MockMemPoolMockRecorder[T, Constraint]) IsConfigBatch(batchHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsConfigBatch", reflect.TypeOf((*MockMemPool[T, Constraint])(nil).IsConfigBatch), batchHash)
}
...
func (m *MockMemPool[T, Constraint]) ReConstructBatchByOrder(oldBatch *mempool.RequestHashBatch[T, Constraint]) ([]string, error) {
	m.ctrl.T.Helper()
