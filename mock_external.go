...
type MockServiceOutbound[T any, Constraint consensus.TXConstraint[T]] struct {
	ctrl     *gomock.Controller
...
type MockServiceOutboundMockRecorder[T any, Constraint consensus.TXConstraint[T]] struct {
	mock *MockServiceOutbound[T, Constraint]
}

// NewMockServiceOutbound creates a new mock instance.
func NewMockServiceOutbound[T any, Constraint consensus.TXConstraint[T]](ctrl *gomock.Controller) *MockServiceOutbound[T, Constraint] {
...
type ServiceOutboundExecuteCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ServiceOutboundSendFilterEventCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ServiceOutboundStateUpdateCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackBroadcastCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackDelStateCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackExecuteCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackGetCurrentEpochInfoCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackGetEpochInfoCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackReadStateCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackReadStateSetCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackSendFilterEventCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackSignCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackStateUpdateCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackStoreStateCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackUnicastCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
...
type ExternalStackVerifyCall[T any, Constraint consensus.TXConstraint[T]] struct {
	*gomock.Call
}
